import type { IncidentAnalysis } from '../contracts/incident-analysis.js';
import type { ModelResponse, ModelTransport } from '../runtime/custom-loop.js';
import { fictionalProvider, type EvidenceProvider } from '../runtime/investigation.js';
