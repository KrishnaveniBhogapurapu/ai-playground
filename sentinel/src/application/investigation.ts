import type { ToolRequest, EvidenceProvider } from '../inputs/evidence.js';
import type { ToolErrorCode, EvidenceResult, AuditEntry } from '../outputs/evidence.js';
import { randomUUID } from 'node:crypto';
import { performance } from 'node:perf_hooks';
import { isDeepStrictEqual } from 'node:util';
import { isAuthorized } from '../policies/evidence-access.js';
import { investigationLimits, localIdentity, policyId, prohibitedActions } from '../constants/investigation.js';
import { SentinelFailure } from '../errors/sentinel-failure.js';
import { serviceMetricsInputSchema, dependencyHealthInputSchema } from '../schemas/evidence-input.js';
import { validateServiceMetricsOutput, validateDependencyHealthOutput } from '../validation/evidence.js';
import { type ServiceMetricsInput, type DependencyHealthInput } from '../inputs/evidence.js';
import { EvidenceUnavailable, fictionalProvider } from '../tools/mock-evidence.js';
import { toolFailure, canonicalToolName } from '../helpers/evidence.js';
