...
The test at [`tests/analysis.test.ts`](../../../tests/analysis.test.ts) performs this sequence:
...
The guard is implemented in [`src/application/turn-acceptance.ts`](../../../src/application/turn-acceptance.ts) and is used by the actual query loop in [`src/index.ts`](../../../src/index.ts).
